...
import { Modal, ModalBody, ModalCloseButton, ModalContent, ModalFooter, ModalHeader, ModalOverlay, Grid, GridItem, Input, FormLabel, Text, Button, FormControl, } from '@chakra-ui/react';
                ...
                <ModalContent>
                    ...
                    <ModalBody>
                        ...
                        <div style={{ display: 'flex', justifyContent: 'flex-end', gap: '8px', marginTop: '16px' }}>
                            <Button size="sm" variant="brand" onClick={handleSubmit} disabled={isLoding || !dirty ? true : false} type="submit">{isLoding ? <Spinner /> : 'Search'}</Button>
