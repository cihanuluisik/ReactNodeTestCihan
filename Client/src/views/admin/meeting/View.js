                        ...
                        <GridItem colSpan={{ base: 4 }}>
                            <Card>
                                <Grid gap={4}>
                                    ...
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Duration </Text>
                                        <Text>{data?.duration ? `${data?.duration} minutes` : '30 minutes (default)'}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                                        <Text fontSize="sm" fontWeight="bold" color={'blackAlpha.900'}> Create For </Text>
                                        <Text>{data?.createFor ? data?.createFor : ' - '}</Text>
                                    </GridItem>
                                    <GridItem colSpan={{ base: 2, md: 1 }}>
                        ...
                        <Grid templateColumns="repeat(6, 1fr)" gap={1}>
                            <GridItem colStart={6} >
                                <Flex justifyContent={"right"}>
                                    {(user.role === 'superAdmin' || permission?.update) ? <Button size='sm' variant="brand" onClick={onEditOpen} leftIcon={<EditIcon />} me={2}>Edit</Button> : ''}
